 @if(Auth::check() && Auth::user()->role == 'admin')
    <div class="col-sm-6 d-none d-none d-lg-block font-weight-bold" style="height: 40px; margin-top: 20px; margin-bottom: 5px;font-size: 20px;">
        <form action="{{route('adauga-penalizare')}}" method="POST" class="prevent-resubmit" style="display: inline-block !important;">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <button type="submit" class="btn btn-success float-right" style="margin-right: -8px"> Adauga </button>
                </div>
            </div>
        </form>
    </div>
