                        ...
                        <table class="table table-striped table-hover text-center" style="margin-bottom: 0;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="{{$tab == 3 ? 'd-none' : ''}}">{{$echipa->meciuri}}</td>
                                    <td class="{{$tab == 3 ? 'd-none' : ''}}">{{$echipa->victorii}}</td>
                                    <td class="d-none d-sm-table-cell">{{$echipa->egaluri}}</td>
                                    <td class="d-none d-sm-table-cell">{{$echipa->infrangeri}}</td>
                                    <td class="text-nowrap{{$tab == 3 ? ' d-none' : ''}}">{{$echipa->marcate}} - {{$echipa->primite}}</td>
                                    <td class="d-none d-sm-table-cell">{{$echipa->golaveraj}}</td>
                                    <td class="{{$tab == 3 ? 'd-none' : ''}}">{{$echipa->puncte}}</td>
