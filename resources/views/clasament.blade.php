                        ...
                        <table class="table table-dark table-hover text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-none d-lg-table-cell">{{$echipa->victorii}}</td>
                                    <td class="d-none d-lg-table-cell">{{$echipa->egaluri}}</td>
                                    <td class="d-none d-lg-table-cell">{{$echipa->infrangeri}}</td>
                                    <td class="text-nowrap d-none d-lg-table-cell">{{$echipa->marcate}} - {{$echipa->primite}}</td>
                                    <td class="d-none d-lg-table-cell">{{$echipa->golaveraj}}</td>
                                    <td>{{$echipa->puncte}}</td>
